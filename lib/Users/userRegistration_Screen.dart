...
class _UserRegistrationScreen extends State<UserRegistrationScreen> {
  ...
  Future<void> signInWithPhoneAuthCredential(BuildContext context,
    ...
    try {
      ...
      try {
        ...
        if (loginUser != null) {
          LoginProvider newLoginProvider = Provider.of<LoginProvider>(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text("   Registration",style: TextStyle(color: clc00a618,fontSize: 28,fontWeight: FontWeight.w600),),
                Column(
                  children: [
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (value) {
                                if (value.trim().length == 10) {
                                  ...
                                  currentSate = MobileVarificationState.SHOW_MOBILE_FORM_STATE2;
                                }
                                setState(() {});
                              },
                                ...
                                suffixIcon: Padding(
                                  ...
                                  child: Container(
                                      ...
                                      child: values.showTick
                                          ...
                                          onTap: ()async{
                                            setState(() {
                                              if (values.userPhoneCT.text.length == 10) {
                                                showLoading = true;
                                                print("bhsdbshs"+values.userPhoneCT.toString());
                                              }
                                            });
  ...
  await auth.verifyPhoneNumber(
      phoneNumber: "+91${values.userPhoneCT.text}",
      ...
      codeAutoRetrievalTimeout: (verificationId) async {
                                          ...
                                          child:  Center(
                                              child: showLoading
                                                  ...
                                                  : Text(currentSate != MobileVarificationState.SHOW_MOBILE_FORM_VERIFIED2
                                                  ?"Verify"
                                                  :"Verified",style: const TextStyle(color: Colors.white),)
                                          )
                                      )
                                          :const Center(child: Text("Verify",style: TextStyle(color: Colors.white)))
                                  ),
                                ),
                      ...
                      Padding(
                        ...
                        child: PinFieldAutoFill(
                          ...
                          decoration:   BoxLooseDecoration(
                            ...
                            radius: Radius.circular(10), strokeColorBuilder: FixedColorBuilder(Colors.grey.shade300),
                          ),
                          onCodeChanged: (pin) {
                            if (pin!.length == 6) {
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        if (form!.validate()) {
                          if( currentSate == MobileVarificationState.SHOW_MOBILE_FORM_VERIFIED2){
                            adminProvider.userRegistration(context,'Self Registration','','');
                          }
